...
class Card_Game_3 extends Phaser.Scene {
	...
	editorCreate() {
		...
		// card_6_2
		const card_6_2 = this.add.image(1407, 718, "_MISSING");

		// card_4_1
		const card_4_1 = this.add.image(1043, 402.875, "_MISSING");

		// card_1_1
		const card_1_1 = this.add.image(497, 402.875, "_MISSING");

		// card_2_2
		const card_2_2 = this.add.image(679, 718, "_MISSING");

		// card_5_1
		const card_5_1 = this.add.image(1225, 402.875, "_MISSING");

		// card_5_2
		const card_5_2 = this.add.image(1225, 718, "_MISSING");

		// card_4_2
		const card_4_2 = this.add.image(1043, 718, "_MISSING");

		// card_6_1
		const card_6_1 = this.add.image(1407, 402.875, "_MISSING");

		// card_1_2
		const card_1_2 = this.add.image(497, 718, "_MISSING");

		// card_3_2
		const card_3_2 = this.add.image(861, 718, "_MISSING");

		// card_2_1
		const card_2_1 = this.add.image(679, 402.875, "_MISSING");

		// card_3_1
		const card_3_1 = this.add.image(861, 402.875, "_MISSING");
		...
		// card_7_1
		const card_7_1 = this.add.image(1589, 402.875, "_MISSING");

		// card_7_2
		const card_7_2 = this.add.image(1589, 718, "_MISSING");

		// txt_level
		const txt_level = this.add.text(314, 301, "", {});
		txt_level.setOrigin(0.5, 0.5);
		txt_level.text = "Level 3";
		...
		// card_8_1
		const card_8_1 = this.add.image(1771, 402.875, "_MISSING");

		// card
		const card = this.add.image(1771, 718, "_MISSING");

		// lists
		const cards = [card_6_2, card_4_1, card_1_1, card_2_2, card_5_1, card_5_2, card_4_2, card_6_1, card_1_2, card_3_2, card_2_1, card_3_1, card_7_2, card_7_1, card_8_1, card];
